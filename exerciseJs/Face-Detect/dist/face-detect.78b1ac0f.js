...
populateVideo().then(detect) // console.log(populateVideo()); // Promise หมายความว่า getUserMedia() เป็น asynchronus function เลย return Promise ออกมา
 // ถ้ากดปุ่มไม่อนุญาตมันจะ Error: Permission Denied แต่ถ้าอนุญาตมันจะ return MediaStream เอามาใช้ในการ put stream 
;

//# sourceMappingURL=face-detect.78b1ac0f.js.map
