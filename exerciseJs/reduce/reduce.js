...
function isValidChar(char) {
    // search a-z and 0-9 (case insensitive)
...
function sortByValue([ , firstNum], [ , secondNum]) {
    return firstNum - secondNum;
}

const result = Object.entries(text.split("").filter(isValidChar).map(lowercase).reduce(instanceCounter, {})).sort(sortByValue);
